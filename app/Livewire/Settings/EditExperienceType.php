...
class EditExperienceType extends Component
{
    ...
    {
        $dataRepository = App::make('ExperienceTypeCrudRepository');
    ...
    {
        $this->dispatch('initializeColorPicker');
        return view('admin.livewire.settings.edit-experience-type');
    }
}
