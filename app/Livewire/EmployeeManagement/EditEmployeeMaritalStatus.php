...
class EditEmployeeMaritalStatus extends Component
{
    ...
    {
        $dataRepository = App::make('EmployeeMaritalStatusCrudRepository');
    ...
    {
        return view('admin.livewire.employee-management.edit-employee-marital-status');
    }
}
