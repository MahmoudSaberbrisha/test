...
class EditEmployeeIdentityType extends Component
{
    ...
    {
        $dataRepository = App::make('EmployeeIdentityTypeCrudRepository');
    ...
    {
        return view('admin.livewire.employee-management.edit-employee-identity-type');
    }
}
