...
class EditEmployeeCardIssuer extends Component
{
    ...
    {
        $dataRepository = App::make('EmployeeCardIssuerCrudRepository');
    ...
    {
        return view('admin.livewire.employee-management.edit-employee-card-issuer');
    }
}
