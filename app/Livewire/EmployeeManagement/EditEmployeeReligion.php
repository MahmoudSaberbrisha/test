...
class EditEmployeeReligion extends Component
{
    ...
    {
        $dataRepository = App::make('EmployeeReligionCrudRepository');
    ...
    {
        return view('admin.livewire.employee-management.edit-employee-religion');
    }
}
