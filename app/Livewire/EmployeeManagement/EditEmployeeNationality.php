...
class EditEmployeeNationality extends Component
{
    ...
    {
        $dataRepository = App::make('EmployeeNationalityCrudRepository');
    ...
    {
        return view('admin.livewire.employee-management.edit-employee-nationality');
    }
}
