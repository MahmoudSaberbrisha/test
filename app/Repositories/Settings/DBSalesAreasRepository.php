...
class DBSalesAreasRepository implements CrudRepositoryInterface
{
    public function getAll()
    {
        return SalesArea::withTranslation()
    ...
    {
        return SalesArea::withTranslation($locale)->with('branch')->findOrFail($id);
    }
