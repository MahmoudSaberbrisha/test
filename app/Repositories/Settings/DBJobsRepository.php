...
class DBJobsRepository implements CrudRepositoryInterface
{
    public function getAll()
    {
        return SettingJob::withTranslation()
            ->select(['id', 'active'])
            ->get();
    }
    ...
    public function create(array $request)
    {
        ...
        return SettingJob::create($data);
    }

    public function findById($id, $locale = null)
    {
        return SettingJob::withTranslation($locale)->findOrFail($id);
    }
