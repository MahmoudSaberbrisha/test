...
class DBPaymentMethodsRepository implements CrudRepositoryInterface
{
    public function getAll()
    {
        return PaymentMethod::withTranslation()
            ->select(['id', 'active'])
            ->get();
    }
    ...
    {
        return PaymentMethod::withTranslation($locale)->findOrFail($id);
    }
