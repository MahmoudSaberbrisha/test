...
class AdminRoleAuthModuleServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'AdminRoleAuthModule';

    protected string $nameLower = 'adminroleauthmodule';
