<div>
    ...
    @if ($reportData)
        <div class="mt-3">
            <div class="row col-6">
                <button class="btn btn-info mb-3" type="button" wire:click="exportPdf"><i
                        class="pl-3 fa fa-file-pdf"></i>{{ __('Export PDF') }}</button>
                <button wire:click="exportExcel" class="btn btn-success mb-3 mr-3"><i class="fa fa-file-excel"></i>
                ...
                <tbody>
                    @forelse($reportData as $data)
                        <tr>
                            ...
                            <td>{{ $data->currency->symbol ?? $data->currency->name }} {{ $data->price }}</td>
                    ...
                    @forelse($reportDataCurrency as $dataCurrency)
                        <tr style="background-color: #e1e4e7;">
                            ...
                            <td>{{ $dataCurrency->currency->symbol ?? $dataCurrency->currency->name }}
                                {{ $dataCurrency->total_price }}</td>
