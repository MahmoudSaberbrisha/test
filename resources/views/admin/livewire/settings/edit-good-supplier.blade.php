<div>
    ...
    @if ($modalData)
        <form wire:loading.remove action="{{route(auth()->getDefaultDriver().'.goods-suppliers.update', $modalData->id)}}" method="POST" enctype="multipart/form-data" class="advanced-form myForm" id="my-form-id" data-parsley-validate x-data x-init="
                ...
                <div class="row m-2">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="phone" wire:model="phone" class="form-control" value="" required>
                        </div>
                    </div>
                </div>
            </div>
