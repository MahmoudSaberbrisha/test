<div>
    ...
    @if ($modalData)
        <form wire:loading.remove action="{{route(auth()->getDefaultDriver().'.client-suppliers.update', $modalData->id)}}" method="POST" enctype="multipart/form-data" class="advanced-form myForm" id="my-form-id" data-parsley-validate x-data x-init="
                ...
                <div class="row m-2">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.5" placeholder="%" class="form-control" data-parsley-min="0" data-parsley-max="100" name="value" wire:model="value" value="" required>
                        </div>
                    </div>
                </div>
            </div>
