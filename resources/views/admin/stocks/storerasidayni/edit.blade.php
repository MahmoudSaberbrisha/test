...
@section('content')
    ...
    <form action="{{ route('admin.storerasidayni.update', $record->id) }}" method="POST" style="color: white;">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-6 mb-3">
                <label for="main_branch_id_fk" class="form-label">Main Branch ID</label>
                <input type="number" class="form-control form-control-3d" id="main_branch_id_fk" name="main_branch_id_fk"
                    required value="{{ old('main_branch_id_fk', $record->main_branch_id_fk) }}">
            </div>
            <div class="col-md-6 mb-3">
                <label for="sub_branch_id_fk" class="form-label">Sub Branch ID</label>
                <input type="number" class="form-control form-control-3d" id="sub_branch_id_fk" name="sub_branch_id_fk"
                    required value="{{ old('sub_branch_id_fk', $record->sub_branch_id_fk) }}">
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 mb-3">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="number" class="form-control form-control-3d" id="publisher" name="publisher"
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control form-control-3d" id="sanf_code" name="sanf_code"
                    value="{{ old('sanf_code', $record->sanf_code) }}">
            </div>
            <div class="col-md-6 mb-3">
                <label for="sanf_id" class="form-label">Sanf ID</label>
                <input type="number" class="form-control form-control-3d" id="sanf_id" name="sanf_id"
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control form-control-3d" id="sanf_name" name="sanf_name"
                    value="{{ old('sanf_name', $record->sanf_name) }}">
            </div>
            <div class="col-md-6 mb-3">
                <label for="sanf_amount" class="form-label">Sanf Amount</label>
                <input type="number" step="any" class="form-control form-control-3d" id="sanf_amount"
                    name="sanf_amount" value="{{ old('sanf_amount', $record->sanf_amount) }}">
            </div>
        </div>
        <div class="d-flex justify-content-between">
            <button type="submit" class="btn btn-primary">تحديث رصيد عيني</button>
            <a href="{{ route('admin.storerasidayni.index') }}" class="btn btn-secondary">إلغاء</a>
        </div>
    </form>
    <style>
        form {
