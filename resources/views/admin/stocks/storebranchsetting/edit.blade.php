...
@section('content')
    ...
    <form action="{{ route('admin.storebranchsetting.update', $branchsetting->id) }}" method="POST" style="color: white;">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control form-control-3d" id="title" name="title" required
                    maxlength="15" value="{{ old('title', $branchsetting->title) }}" style="color: black;">
            </div>
            <div class="col-md-6 mb-3">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control form-control-3d" id="lat_map" name="lat_map" maxlength="15"
                    value="{{ old('lat_map', $branchsetting->lat_map) }}" style="color: black;">
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control form-control-3d" id="long_map" name="long_map" maxlength="15"
                    value="{{ old('long_map', $branchsetting->long_map) }}" style="color: black;">
            </div>
        </div>
