...
@section('content')
    ...
    <form action="{{ route('admin.storeothersupplier.update', $supplier->id) }}" method="POST" style="color: white;">
        @csrf
        @method('PUT')
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control form-control-3d @error('name') is-invalid @enderror"
                    id="name" name="name" required maxlength="255" value="{{ old('name', $supplier->name) }}">
                @error('name')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control form-control-3d @error('supplier_phone') is-invalid @enderror"
                    id="supplier_phone" name="supplier_phone" maxlength="50"
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control form-control-3d @error('supplier_fax') is-invalid @enderror"
                    id="supplier_fax" name="supplier_fax" maxlength="50"
                    value="{{ old('supplier_fax', $supplier->supplier_fax) }}">
                @error('supplier_fax')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
                ...
                <select class="form-select form-control-3d @error('accountant_name') is-invalid @enderror"
                    ...
                    @foreach ($employees as $employee)
                        <option value="{{ $employee->name }}"
                            {{ old('accountant_name', $supplier->accountant_name) == $employee->name ? 'selected' : '' }}>
                            {{ $employee->name }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="number" step="any"
                    ...
                    name="supplier_dayen" value="{{ old('supplier_dayen', $supplier->supplier_dayen) }}">
