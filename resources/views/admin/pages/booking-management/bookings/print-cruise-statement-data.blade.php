...
<body>
    ...
    <div style="text-align: center; margin-bottom: 20px;">
        ...
        <br>
        <span><strong>{{ __('Booking Type') }}</strong>: {{ $data['booking']->type->name . ' - ' . __($data['booking']->booking_type) . ' - ' . $data['booking']->branch->name . ' ( ' . $data['booking']->start_time->format('H:i') . ' )' }}</span>
        <br>
