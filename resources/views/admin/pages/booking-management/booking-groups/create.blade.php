...
@section('page_title', __('New Booking Group'))
@section('breadcrumb')
    @include('admin.partials.breadcrumb', ['breads' => [__('Bookings Management'), __('New Booking Group')]])
@endsection
...
@section('content')
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route(auth()->getDefaultDriver() . '.booking-groups.store') }}" enctype="multipart/form-data" autocomplete="nop" id="my-form-id" data-parsley-validate>
                            @csrf
                            <div class="modal-body m-2">

                                <livewire:booking-management.create-edit-booking-group />
